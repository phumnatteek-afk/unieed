...
const rightAccount = () => {
  ...
  const pct =
    needed > 0 ? Math.min(Math.round((fulfilled / needed) * 100), 100) : 0;
            ...
            <div className="pdHeroCard">
              ...
              <div className="pdRight">
                ...
                <div className="pdChannels">
                  <div
                    className={`pdChannel ${selectedMethod === "parcel" ? "pdChannelActive" : ""}`}
                    onClick={() => setSelectedMethod("parcel")}
                  >
                    <svg
                      width="43"
                      height="31"
                    ...
                    >
                      <path
                        d="M43 21.8149C43 24.3511 40.8607 26.4075 38.2222 26.4075H4.77778C2.13925 26.4075 0 24.3511 0 21.8149V18.3705C0 15.8343 2.13925 13.778 4.77778 13.778H38.2222C40.8607 13.778 43 15.8343 43 18.3705V21.8149Z"
                        fill="#DD2E44"
                      />
                      <path
                        d="M22.6944 5.74067L21.5251 4.59253H8.5355C4.77778 4.59253 3.58333 6.8888 3.58333 6.8888L0 13.7305V19.5183H22.6944V5.74067Z"
                        fill="#FFEEC3"
                      />
                      <path
                        d="M10.7498 13.7779H2.38867L4.77756 9.18531C4.77756 9.18531 5.97201 6.88904 8.36089 6.88904H10.7498V13.7779Z"
                        fill="#55ACEE"
                      />
                      <path
                        d="M10.7504 31C13.3891 31 15.5282 28.9439 15.5282 26.4075C15.5282 23.8711 13.3891 21.8149 10.7504 21.8149C8.11174 21.8149 5.97266 23.8711 5.97266 26.4075C5.97266 28.9439 8.11174 31 10.7504 31Z"
                        fill="#292F33"
                      />
                      <path
                        d="M10.7502 28.7034C12.0696 28.7034 13.1391 27.6753 13.1391 26.4071C13.1391 25.1389 12.0696 24.1108 10.7502 24.1108C9.43087 24.1108 8.36133 25.1389 8.36133 26.4071C8.36133 27.6753 9.43087 28.7034 10.7502 28.7034Z"
                        fill="#CCD6DD"
                      />
                      <path
                        d="M32.2504 31C34.8891 31 37.0282 28.9439 37.0282 26.4075C37.0282 23.8711 34.8891 21.8149 32.2504 21.8149C29.6117 21.8149 27.4727 23.8711 27.4727 26.4075C27.4727 28.9439 29.6117 31 32.2504 31Z"
                        fill="#292F33"
                      />
                      <path
                        d="M32.2502 28.7034C33.5696 28.7034 34.6391 27.6753 34.6391 26.4071C34.6391 25.1389 33.5696 24.1108 32.2502 24.1108C30.9309 24.1108 29.8613 25.1389 29.8613 26.4071C29.8613 27.6753 30.9309 28.7034 32.2502 28.7034Z"
                        fill="#CCD6DD"
                      />
                      <path
                        d="M38.2218 0.00012207H20.3051C17.6666 0.00012207 15.5273 2.05643 15.5273 4.59267V19.5184H42.9996V4.59267C42.9996 2.05643 40.8603 0.00012207 38.2218 0.00012207Z"
                        fill="#CCD6DD"
                      />
                    </svg>
                  ...
                  <div
                    className={`pdChannel ${selectedMethod === "dropoff" ? "pdChannelActive" : ""}`}
                  ...
                  >
                    ...
                    >
                      <path
                        d="M0.00195312 13.5022V28.7514C0.00195312 31.2677 1.60232 31.8124 1.60232 31.8124L18.549 43.0247C21.2167 44.7893 20.5008 41.0741 20.5008 41.0741V27.0571L0.00195312 13.5022Z"
                        fill="#662113"
                      />
                      <path
                        d="M41 13.5022V28.7514C41 31.2677 39.4435 31.8124 39.4435 31.8124C39.4435 31.8124 25.1427 41.2601 22.4764 43.0247C19.8071 44.7893 20.5012 41.0741 20.5012 41.0741V27.0571L41 13.5022Z"
                        fill="#C1694F"
                      />
                      <path
                        d="M22.3869 0.56376C21.2843 -0.18792 19.4761 -0.18792 18.3721 0.56376L0.828005 12.306C-0.276002 13.0577 -0.276002 14.2862 0.828005 15.0367L18.4321 26.9231C19.5361 27.6735 21.3444 27.6735 22.4484 26.9231L40.1711 14.9332C41.2751 14.1827 41.2751 12.9542 40.1711 12.2025L22.3869 0.56376Z"
                        fill="#D99E82"
                      />
                      <path
                        d="M20.4994 43.9999C19.6911 43.9999 19.0352 43.406 19.0352 42.6715V26.7421C19.0352 26.0076 19.6911 25.4137 20.4994 25.4137C21.3091 25.4137 21.9636 26.0076 21.9636 26.7421V42.6715C21.9636 43.406 21.3091 43.9999 20.4994 43.9999Z"
                        fill="#D99E82"
                      />
                      <path
                        d="M35.1426 23.1575C35.1426 24.5179 35.2949 25.1858 33.6784 26.1667L30.0633 28.4809C28.4468 29.463 27.8216 28.6201 27.8216 27.2585V23.6097C27.8216 23.3719 27.7835 23.1168 27.4146 22.8605C23.6398 20.242 8.9832 10.4442 6.3125 8.63529L13.0844 4.10303C14.9381 5.2441 28.829 14.2717 34.6404 18.1225C34.9288 18.3147 35.1426 18.5266 35.1426 18.7583V23.1575Z"
                        fill="#99AAB5"
                      />
                      <path
                        d="M34.6389 18.1225C28.829 14.2717 14.9381 5.2441 13.0844 4.10303L10.5645 5.78876L6.3125 8.63529C8.98467 10.4442 23.6398 20.242 27.4146 22.8605C27.6356 23.0145 27.7323 23.1686 27.7777 23.3177L35.0006 18.4305C34.9127 18.3233 34.7868 18.2198 34.6389 18.1225Z"
                        fill="#CCD6DD"
                      />
                      <path
                        d="M35.1423 23.1575V18.7583C35.1423 18.5267 34.9285 18.3159 34.6386 18.1225C28.8287 14.2717 14.9378 5.2441 13.0841 4.10303L10.0488 6.13503C15.0169 9.42393 28.3235 18.0646 31.8068 20.396C32.1817 20.6474 32.2139 20.9074 32.2139 21.1452V27.1044L33.6781 26.1667C35.2946 25.1846 35.1423 24.5179 35.1423 23.1575Z"
                        fill="#CCD6DD"
                      />
                      <path
                        d="M34.6386 18.1225C28.8287 14.2716 14.9378 5.2441 13.0841 4.10303L10.0488 6.13503C15.0169 9.42393 28.3235 18.0645 31.8068 20.396C31.861 20.4317 31.8947 20.4687 31.9342 20.5044L35.0003 18.4305C34.9124 18.3233 34.7865 18.2198 34.6386 18.1225Z"
                        fill="#E1E8ED"
                      />
                    </svg>
                    <span>Drop-off</span>
                  ...
                  <div
                    className={`pdChannel ${selectedMethod === "buy" ? "pdChannelActive" : ""}`}
                    onClick={() => setSelectedMethod("buy")}
                  >
                    <svg
                      width="43"
                      height="43"
                    ...
                    >
                      <g clip-path="url(#clip0_2661_950)">
                        <path
                          d="M21.5 42.9982C33.3743 42.9982 43 33.3725 43 21.4982C43 9.62662 33.3743 0 21.5 0C9.62573 0 0 9.62573 0 21.4991C0 33.3725 9.62573 42.9982 21.5 42.9982Z"
                          fill="#32BEA6"
                        />
                        <path
                          d="M30.8721 17.5189C30.8542 17.3247 30.7645 17.1443 30.6205 17.0129C30.4765 16.8814 30.2886 16.8086 30.0936 16.8085H12.7574C12.5621 16.8077 12.3737 16.8803 12.2293 17.0118C12.085 17.1434 11.9953 17.3243 11.9781 17.5189L10.5582 33.1547C10.5479 33.2631 10.5604 33.3724 10.595 33.4756C10.6295 33.5788 10.6853 33.6736 10.7587 33.754C10.8322 33.8343 10.9216 33.8984 11.0213 33.9421C11.121 33.9858 11.2287 34.0081 11.3375 34.0076H31.5153C31.6239 34.0074 31.7312 33.9846 31.8306 33.9407C31.9299 33.8968 32.019 33.8327 32.0922 33.7525C32.1654 33.6723 32.2211 33.5777 32.2558 33.4748C32.2905 33.3719 32.3035 33.2629 32.2938 33.1547L30.8721 17.5189Z"
                          fill="#FACB1B"
                        />
                        <path
                          d="M12.7592 16.8085C12.5641 16.8083 12.3759 16.8811 12.2317 17.0125C12.0875 17.144 11.9977 17.3246 11.9798 17.5189L10.5599 33.1547C10.5451 33.3156 10.5807 33.4772 10.6618 33.617C10.7428 33.7568 10.8653 33.8679 11.0123 33.935L28.1388 16.8085H12.7592Z"
                          fill="#FBE158"
                        />
                        <path
                          d="M17.9933 17.7482C17.5962 17.6293 17.1681 17.6729 16.8031 17.8694C16.4381 18.066 16.166 18.3994 16.0467 18.7964C15.7986 19.6241 16.62 22.326 16.62 22.326C16.62 22.326 18.7933 20.5226 19.0415 19.6949C19.1005 19.4983 19.1202 19.2919 19.0994 19.0877C19.0787 18.8834 19.0179 18.6852 18.9206 18.5045C18.8233 18.3237 18.6913 18.1639 18.5322 18.0341C18.3731 17.9044 18.19 17.8072 17.9933 17.7482ZM16.4525 18.9935C16.5378 18.7097 16.7324 18.4714 16.9933 18.331C17.2543 18.1906 17.5604 18.1597 17.8442 18.245C18.128 18.3303 18.3663 18.5248 18.5067 18.7858C18.647 19.0468 18.678 19.3529 18.5927 19.6367C18.4153 20.227 16.8628 21.5152 16.8628 21.5152C16.8628 21.5152 16.276 19.5847 16.4534 18.9943"
                          fill="#5B5C5F"
                        />
                        <path
                          d="M17.5898 19.1529C17.797 19.1529 17.9958 19.0706 18.1424 18.9241C18.2891 18.7777 18.3716 18.579 18.3718 18.3717V13.6811C18.3725 12.8519 18.7022 12.0567 19.2885 11.4702C19.8748 10.8838 20.6699 10.5538 21.4992 10.5529C22.328 10.5541 23.1225 10.8839 23.7086 11.4699C24.2947 12.056 24.6245 12.8505 24.6256 13.6794V18.3708C24.6256 18.5782 24.708 18.7772 24.8547 18.9238C25.0014 19.0705 25.2003 19.1529 25.4077 19.1529C25.6151 19.1529 25.814 19.0705 25.9607 18.9238C26.1074 18.7772 26.1898 18.5782 26.1898 18.3708V13.6802C26.1658 12.4521 25.661 11.2824 24.784 10.4223C23.9069 9.56222 22.7276 9.08044 21.4992 9.08044C20.2708 9.08044 19.0914 9.56222 18.2144 10.4223C17.3373 11.2824 16.8326 12.4521 16.8086 13.6802V18.3708C16.8086 18.5781 16.8909 18.7769 17.0373 18.9235C17.1838 19.0702 17.3825 19.1527 17.5898 19.1529Z"
                          fill="#84462D"
                        />
                        <path
                          d="M18.3735 26.9718C18.3735 27.1792 18.2911 27.3781 18.1444 27.5248C17.9977 27.6715 17.7988 27.7539 17.5914 27.7539H16.0282C15.9254 27.7542 15.8235 27.7342 15.7285 27.695C15.6334 27.6559 15.5471 27.5983 15.4744 27.5256C15.4017 27.4529 15.3441 27.3665 15.3049 27.2715C15.2657 27.1764 15.2457 27.0746 15.2461 26.9718V22.2812C15.2461 22.1785 15.2663 22.0768 15.3056 21.9819C15.3449 21.887 15.4025 21.8008 15.4752 21.7282C15.5478 21.6556 15.634 21.598 15.7289 21.5587C15.8238 21.5194 15.9255 21.4991 16.0282 21.4991H17.5914C17.7988 21.4991 17.9977 21.5815 18.1444 21.7282C18.2911 21.8749 18.3735 22.0738 18.3735 22.2812V26.9718Z"
                          fill="white"
                        />
                      </g>
                      <defs>
...
<button
  ...
  onClick={() => navigate(`/donate/${requestId}?method=${selectedMethod}`)}
>
  ส่งต่อ
</button>
                <p className="pdNote">
                  *รับเกียรติบัตรออนไลน์ เพียงอัปโหลดหลักฐานการส่งต่อของท่าน*
                </p>
              </div>
            </div>
            ...
            <span className="pdUniformQty">{item.quantity} ชิ้น</span>
                ...
                <div className="pdDetailRight">
                  ...
                  <div className="pdContactItem">
                    ...
                    >
                      <path
                        d="M12.4125 20.2312C15.1125 25.5375 19.4625 29.8687 24.7688 32.5875L28.8937 28.4625C29.4 27.9563 30.15 27.7875 30.8063 28.0125C32.9063 28.7062 35.175 29.0813 37.5 29.0813C38.5313 29.0813 39.375 29.925 39.375 30.9563V37.5C39.375 38.5313 38.5313 39.375 37.5 39.375C19.8937 39.375 5.625 25.1063 5.625 7.5C5.625 6.46875 6.46875 5.625 7.5 5.625H14.0625C15.0938 5.625 15.9375 6.46875 15.9375 7.5C15.9375 9.84375 16.3125 12.0938 17.0062 14.1938C17.2125 14.85 17.0625 15.5813 16.5375 16.1063L12.4125 20.2312Z"
                        fill="#F7AD19"
                      />
                    </svg>
                    <div>
                  ...
                  <div className="pdContactItem">
                    ...
                    >
                      <path
                        d="M37.5 7.5H7.5C5.4375 7.5 3.76875 9.1875 3.76875 11.25L3.75 33.75C3.75 35.8125 5.4375 37.5 7.5 37.5H37.5C39.5625 37.5 41.25 35.8125 41.25 33.75V11.25C41.25 9.1875 39.5625 7.5 37.5 7.5ZM37.5 15L22.5 24.375L7.5 15V11.25L22.5 20.625L37.5 11.25V15Z"
                        fill="#F7AD19"
                      />
                    </svg>
                    <div>
                  ...
                  {project.contact_person && (
                    <div className="pdContactPerson">
                      ...
                      <div className="pdPersonRow">
                        ...
                        >
                          <span className="pdPersonSchool">
                            {project.school_name}
                          </span>
                          <span className="pdPersonName">
                            โดย {project.contact_person}
                          </span>
                        </div>
                      </div>
                    </div>
